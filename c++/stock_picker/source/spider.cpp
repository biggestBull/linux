...
int stockpicker::SpiderStocksOverview::getAllStocks(std::string spec_stock){
	...
	#define _PARAMS "&pn=1&pz=14&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&wbp2u=|0|0|0|web&fid=f3&fs=m:0+t:6,m:0+t:80,m:1+t:2,m:1+t:23,m:0+t:81+s:2048&"
